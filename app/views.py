...
class ProductView(View):
	def get(self, request):
		...
		Shades = Product.objects.filter(category='SH')
		Laptop = Product.objects.filter(category='L')
		if request.user.is_authenticated:
			totalitem = len(Cart.objects.filter(user=request.user))
		return render(request, 'app/home.html', {'Shoes':Shoes,'Laptop':Laptop, 'mobiles':mobiles,'Shades':Shades, 'totalitem':totalitem})
...
def mobile(request, data=None):
	...
	if data==None :
			mobiles = Product.objects.filter(category='M')
	elif data == 'OPPO' or data == 'OnePlus' or data == 'Iphone':
...
def Shoes(request, data=None):
	...
	if data==None :
			Shoes = Product.objects.filter(category='S')
	elif data == 'Puma' or data == 'Nike' or data == 'ASICS':
